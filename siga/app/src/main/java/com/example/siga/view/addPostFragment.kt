    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addBtn.setOnClickListener{
            ...
            if (locationText.text.toString() != "" && descriptionText.text.toString() != "" && imageAdded){
                ...
                var post: Post = Post()
                var postLocal: LocalPost = LocalPost()

                post.location = locationText.text.toString()
                post.description = descriptionText.text.toString()
                ...
                postLocal.username = homeActivity.userName
                postLocal.mediaUrl = mediaUrl
                postLocal.userUrl = homeActivity.userImageUrl
